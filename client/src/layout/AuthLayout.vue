                ...
                <div class="row align-items-center justify-content-xl-between">
                    <div class="col-xl-6">
                        <div class="copyright text-center text-xl-left text-muted">
                            &copy; {{year}} <a href="https://chest.store" class="font-weight-bold ml-1"
                                               target="_blank">chest.store</a>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <ul class="nav nav-footer justify-content-center justify-content-xl-end">
                            <li class="nav-item">
                                <a href="https://chest.store" class="nav-link" target="_blank">chest.store</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://github.com/whatl3y/chest.store" class="nav-link" target="_blank">Github</a>
                            </li>
                            <!-- <li class="nav-item">
                                <a href="http://blog.creative-tim.com" class="nav-link" target="_blank">Blog</a>
                            </li> -->
                            <li class="nav-item">
                                <a href="https://github.com/whatl3y/chest.store/blob/master/LICENSE"
