...
const postgresUrl = process.env.DATABASE_TEST_URL || 'postgres://localhost:5432/cheststore_test'
...
describe('DatabaseModel', () => {
  ...
  const users = Object.assign(DatabaseModel(postgres, 'users'), { accessibleColumns: [ 'name', 'username' ] })
  ...
  describe('#getAll', function() {
    ...
    it(`should get all user records in the DB`, async function() {
      ...
      await postgres.query(`insert into users (username) values ('lance@acme.com')`)
